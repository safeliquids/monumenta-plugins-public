...
public class AuditListener implements Listener {
	...
	static {
		List<Pattern> ignoredCommandRegex = new ArrayList<>(List.of(
			...
			exactOptionalArguments("(minecraft:)?charmbag withdraw"),
			exactOptionalArguments("(minecraft:)?claimraffle"),
			exactOptionalArguments("(minecraft:)?dailies"),
			exactOptionalArguments("(minecraft:)?(disabledrop|dd)"),
			exactOptionalArguments("(minecraft:)?dungeons"),
			exactOptionalArguments("(minecraft:)?(enchantments|enchants)"),
			...
			exactOptionalArguments("(minecraft:)?(playerabilities|pa)"),
			...
			exactOptionalArguments("(minecraft:)?showmydps"),
